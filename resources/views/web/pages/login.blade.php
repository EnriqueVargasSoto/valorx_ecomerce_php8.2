        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                <div class="image-contain">
                    <img src="{{asset ('web/assets/images/inner-page/log-in.png')}}" class="img-fluid" alt="">
                </div>
            </div>
                ...
                <div class="log-in-box">
                    ...
                    <div class="input-box">
                        <form class="row g-4" action="{{route('auth')}}" method="POST">
                            ...
                            <div class="col-12">
                                <button class="btn btn-animation w-100 justify-content-center" type="submit">Ingresar</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="sign-up-box">
                        ...
                        <a href="sign-up.html">Inscribirse</a>
                    </div>
                </div>
            </div>
        </div>
